  ...
  return (
    <div className="flex cursor-pointer rounded-md  shadowshadow-lg border border-red-500 bg-white hover:border hover:border-gray-600">
      ...
      >
        ...
        <DialogActions>
          <Button variant='contained' auto-focus sx={{backgroundColor:"orangered", color:"orange" ,"&:hover":{"backgroundColor":"rgb(255, 123, 0)" , "color":"white"}}} onClick={()=>setToggleDialogBox(!toggleDialogBox)}>
            Close
          </Button>
        </DialogActions>
